...
class OwnerValidator extends ConstraintValidator
{
    ...
    protected function isValidOwner(
        ...
        return $this->isValidExistingOwner($ownershipMetadata, $entityMetadata, $owner, $accessLevel, $entity);
    }

    /**
     * @return Organization
     */
    protected function getOrganization($ownershipMetadata, $entityMetadata, $entity)
    {
        ...
        return $organization ?? $this->tokenAccessor->getOrganization();
    }
     ...
     * @return bool
     */
    private function isValidExistingOwner(OwnershipMetadataInterface $ownershipMetadata, $entityMetadata, $owner, $accessLevel, $entity)
    {
        $organization = $this->getOrganization($ownershipMetadata, $entityMetadata, $entity);
        ...
        if ($ownershipMetadata->isOrganizationOwned()) {
            return AccessLevel::SYSTEM_LEVEL ==  $accessLevel ? true:  in_array(
                $owner->getId(),
